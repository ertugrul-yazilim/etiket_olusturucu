...
class EtiketUygulamasi:
    ...
    def guncelleme_kontrol_et(self):
        GUNCELLEME_URL = "https://raw.githubusercontent.com/KULLANICI_ADI/REPO_ADI/main/guncelleme.txt"  # Burayı kendi github adresinle değiştir
    ...
    def _guncelleme_popup(self, yeni_surum, indir_url, changelog):
        ...
        msg = f"Yeni sürüm bulundu: {yeni_surum}\n\nDeğişiklikler:\n{changelog}\n\nİndirmek ve kurmak ister misiniz?"
