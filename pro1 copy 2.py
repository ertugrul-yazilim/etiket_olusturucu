...
class EtiketUygulamasi:
    def __init__(self, root):
        ...
        updatemenu.add_command(label="Güncelleme Bilgisi", command=self.show_update_info)
    ...
    def show_about(self):
        self.show_info("Hakkında", "Bu uygulama satranç turnuvaları için etiket ve katılım belgesi oluşturmak amacıyla geliştirilmiştir.\n\nGeliştirici: Ertuğrul Kamil ŞAHİN\nLisans No: 9894\nİletişim: ertugrul.yazilim@gmail.com\nSürüm: " + APP_VERSION)
